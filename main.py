...
class MainWindow:
    ...
    def startPuntoFijo(self):
        if '/x' in self.entry_functionpt.get() and self.entry_apt.get() == '0' and '/x' in self.entry_gfunction.get():
            ...
            self.labelalert = tkinter.Label(self.windowsalert, text="No se puede dividir entre cero", font="Helvetica 13", background="darkgray")
            ...
            self.title.grid(row=0, column=0, columnspan=3, sticky="nsew")
            self.label_respt = tkinter.Label(self.windowrespt, text="La raíz se encuentra en:", font="Helvetica 13",background="darkgray")
            self.label_respt.grid(row=1, column=0, padx=3, pady=3)
            resultpt=punto(self.entry_functionpt.get(),self.entry_gfunction.get(),self.entry_apt.get(),self.entry_errapt.get(),self.entry_it.get())
            self.label_respt = tkinter.Label(self.windowrespt, text=str(resultpt[1]), font="Helvetica 13",background="darkgray")
            self.label_respt.grid(row=1, column=1, padx=3, pady=3)
            self.label_errpt = tkinter.Label(self.windowrespt, text="El error es :", font="Helvetica 13",background="darkgray")
            self.label_errpt.grid(row=2, column=0, padx=3, pady=3)
            self.label_errbpt = tkinter.Label(self.windowrespt, text=str(resultpt[2]), font="Helvetica 13",background="darkgray")
            ...
            back_mainpt = tkinter.Button(self.windowrespt, text="Regresar", width=10, height=2,command=lambda: self.back(self.windowrespt))
    ...
    def biseccion(self):
        ...
        # INGRESO INTERVALO a
        self.label_x0 = tkinter.Label(self.windowbis, text="Valor a intervalo [a,b]:", font="Helvetica 13",background="darkgray")
    ...
    def startBiseccion(self):
        if '/x' in self.entry_functionbis.get() and float(self.entry_x0bis.get()) <= 0 and float(self.entry_intervalBbis.get()) >= 0:
            ...
            self.label_resb = tkinter.Label(self.windowresbis, text=str(result[3]), font="Helvetica 13",background="darkgray")
            self.label_resb.grid(row=1, column=1, padx=3, pady=3)
            self.label_err = tkinter.Label(self.windowresbis, text="El error es :", font="Helvetica 13",background="darkgray")
            self.label_err.grid(row=2, column=0, padx=3, pady=3)
            self.label_errb = tkinter.Label(self.windowresbis, text=str(result[2]), font="Helvetica 13",background="darkgray")
            ...
            back_main.grid(row=5, column=0, padx=10, pady=10)
            show_table = tkinter.Button(self.windowresbis, text="Mostrar tabla", width=10, height=2,command=self.showtablebis)
    ...
    def startSecante(self):
        if '/x' in self.entry_functionsec.get() and float(self.entry_x0sec.get()) <= 0 and float(self.entry_x1sec.get()) >= 0:
            ...
            self.label_res.grid(row=1, column=0, padx=3, pady=3)
            resultsec = secante(self.entry_functionsec.get(),self.entry_x0sec.get(),self.entry_x1sec.get(),self.entry_errsec.get())
            self.label_resb = tkinter.Label(self.windowressec, text=str(resultsec[1]), font="Helvetica 13", background="darkgray")
            self.label_resb.grid(row=1, column=1, padx=3, pady=3)
            self.label_err = tkinter.Label(self.windowressec, text="El error es :", font="Helvetica 13",background="darkgray")
            self.label_err.grid(row=2, column=0, padx=3, pady=3)
            self.label_errsec = tkinter.Label(self.windowressec, text=str(resultsec[2]), font="Helvetica 13",background="darkgray")
            ...
            canvas.draw()
            canvas.get_tk_widget().grid(row=3, column=0, columnspan=2, padx=3, pady=3)
            back_mainsec = tkinter.Button(self.windowressec, text="Regresar", width=10, height=2,command=lambda: self.back(self.windowressec))
            back_mainsec.grid(row=5, column=0, padx=10, pady=10)
            show_table = tkinter.Button(self.windowressec, text="Mostrar tabla", width=10, height=2,command=self.showtablesec)
            show_table.grid(row=5, column=1, padx=10, pady=10)
    ...
    def showtablesec(self):
        ...
        table.column("col2", width=100)
        table.column("col3", width=100)
        tabla =secante(self.entry_functionsec.get(),self.entry_x0sec.get(),self.entry_x1sec.get(),self.entry_errsec.get())[3]
        files = tabla.tolist()
        for i, fila in enumerate(files):
    ...
    def startTrapecio(self):
        if '/x' in self.entry_functiontrap.get() and float(self.entry_x0trap.get()) <= 0 and float(self.entry_intervalBtrap.get()) >= 0:
            ...
            self.label_res.grid(row=1, column=0, padx=3, pady=3)
            resultstrap = trapecio(self.entry_functiontrap.get(), self.entry_x0trap.get(), self.entry_intervalBtrap.get(),self.entry_ntrap.get())
            self.label_resb = tkinter.Label(self.windowrestrap, text=str(resultstrap[2]), font="Helvetica 13", background="darkgray")
            self.label_resb.grid(row=1, column=1, padx=3, pady=3)
            self.label_err = tkinter.Label(self.windowrestrap, text="El error es :", font="Helvetica 13",background="darkgray")
            self.label_err.grid(row=2, column=0, padx=3, pady=3)
            self.label_errsec = tkinter.Label(self.windowrestrap, text=str(resultstrap[3]), font="Helvetica 13",background="darkgray")
            self.label_errsec.grid(row=2, column=1, padx=3, pady=3)
            fig = resultstrap[0]
            fig.set_size_inches(4, 3)
            ...
            canvas.draw()
            canvas.get_tk_widget().grid(row=3, column=0, columnspan=2, padx=3, pady=3)
            back_maintrap = tkinter.Button(self.windowrestrap, text="Regresar", width=10, height=2,command=lambda: self.back(self.windowrestrap))
    ...
    def startSimpson(self):
        if '/x' in self.entry_functionsim.get() and float(self.entry_x0sim.get()) <= 0 and float(self.entry_intervalBsim.get()) >= 0 :
            ...
            self.label_res.grid(row=1, column=0, padx=3, pady=3)
            self.label_resb = tkinter.Label(self.windowressimp, text=str(resultsimp[1]), font="Helvetica 13",background="darkgray")
            self.label_resb.grid(row=1, column=1, padx=3, pady=3)
            self.label_err = tkinter.Label(self.windowressimp, text="El error es :", font="Helvetica 13",background="darkgray")
            self.label_err.grid(row=2, column=0, padx=3, pady=3)
            self.label_errsec = tkinter.Label(self.windowressimp, text=str(resultsimp[2]), font="Helvetica 13",background="darkgray")
            self.label_errsec.grid(row=2, column=1, padx=3, pady=3)
            fig = resultsimp[0]
            fig.set_size_inches(4, 3)
